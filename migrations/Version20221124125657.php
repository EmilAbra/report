 ...
 */
final class Version20221124125657 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, acronym, roles, password FROM user');
        ...
        $this->addSql('INSERT INTO user (id, acronym, roles, password) SELECT id, acronym, roles, password FROM __temp__user');
